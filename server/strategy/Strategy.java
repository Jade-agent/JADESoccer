...
public interface Strategy extends Serializable{
	...
	Action chooseAction(Message msg, boolean isHomeTeam, int numPlayer);
	
	boolean hasToClone(); // this has to return true if the strategy contains complex fields and therefore needs a deepCopy
